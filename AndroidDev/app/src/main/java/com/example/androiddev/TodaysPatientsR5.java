...
public class TodaysPatientsR5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TodaysPatientsR5.this, AllPatients_R5.class);
        ...
        try {
            patientList = okHttpHandler.populateScrollView("http://" + myIP + "/flexFitDBServices/get_todays_patients.php?vatRegNum=" + vatRegNum);
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
    ...
    private void inflatePatientCards(LinearLayout linearLayout, Patient patient) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TodaysPatientsR5.this, PatientContactR5.class);
