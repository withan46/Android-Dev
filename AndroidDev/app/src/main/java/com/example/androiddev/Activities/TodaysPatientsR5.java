    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TodaysPatientsR5.this, AllPatientsR5.class);
        ...
        try {
            patientList = okHttpHandler.populateScrollView("http://" + myIP + "/flexFitDBServices/getTodaysPatientsR5.php?vatRegNum=" + vatRegNum);
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
